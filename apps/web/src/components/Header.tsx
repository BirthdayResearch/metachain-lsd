    ...
    <>
      <div
        className={clsx(
          ...
          "sticky z-50 py-5 lg:flex top-0 header-bg md:py-10 w-full flex items-center justify-between font-mono text-sm mb-8 md:mb-16",
        )}
      >
        <div className="flex w-full items-center px-5  justify-between md:pt-0 pt-2">
          <MarbleFiLogo
