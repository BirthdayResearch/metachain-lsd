const securityHeaders = [
  {
    ...
    value:
      ...
      `connect-src 'self' ${process.env.NEXT_PUBLIC_SERVER_URL} rpc.ankr.com mainnet.infura.io cloudflare-eth.com eth.testnet.ocean.jellyfishsdk.com mainnet.ocean.jellyfishsdk.com ${
