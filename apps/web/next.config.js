const securityHeaders = [
  {
    ...
    value:
      ...
      `connect-src 'self' ${process.env.NEXT_PUBLIC_SERVER_URL} rpc.ankr.com rpc.sepolia.org eth.testnet.ocean.jellyfishsdk.com mainnet.infura.io eth.mainnet.ocean.jellyfishsdk.com ${
