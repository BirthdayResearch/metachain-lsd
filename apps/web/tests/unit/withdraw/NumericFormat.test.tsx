  ...
  test("formats '0.000000001' correctly when trimTrailingZeros is false", () => {
    render(
      <NumericFormat
        ...
        value={new BigNumber("0.000000001")}
      />,
    );
